...
private:
    ...
    void createInstance()
    {
        ...
        // Creates usefull information for the driver
        ...
        // Tells Vulkan driver which global extensions and validation layers we want to use, global means they apply to the whole program and not specific device 
